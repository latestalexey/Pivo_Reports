...
Процедура КоманднаяПанельФормыПериодыСравнений(Кнопка)
	Форма=ПолучитьФорму("ФормаНастройкиПериодов");
	Форма.ОткрытьМодально();
	Если ПериодыСравнения.Количество() Тогда
		ЭлементыФормы.КоманднаяПанельФормы.Кнопки.ПериодыСравнений.Текст="Периоды ("+Строка(ПериодыСравнения.Количество())+")";
	Иначе
		ЭлементыФормы.КоманднаяПанельФормы.Кнопки.ПериодыСравнений.Текст="Периоды";
	КонецЕсли;
