...
Процедура ЗаполнитьАвтоБухгалтерияКОРП(СписокОрганизаций)
	...
	|						И ХозрасчетныйОбороты.Регистратор.Склад.ВидСклада = ЗНАЧЕНИЕ(Перечисление.ВидыСкладов.Розничный)
	|				ТОГДА ХозрасчетныйОбороты.КоличествоОборотКт * АлкогольнаяПродукция.КоэффПересчетаДал
	|			ИНАЧЕ 0
	|		КОНЕЦ) КАК П000010000114,
	|	СУММА(ВЫБОР
	...
	|	КОНЕЦ КАК П000020000105,
	|	ВЫБОР
	|		КОГДА ХозрасчетныйОбороты.Регистратор.Грузоотправитель ЕСТЬ НЕ NULL 
	|				И ХозрасчетныйОбороты.Регистратор.Контрагент.КПП <> ХозрасчетныйОбороты.Регистратор.Грузоотправитель.КПП
	|			ТОГДА ВЫРАЗИТЬ(ХозрасчетныйОбороты.Регистратор.Грузоотправитель.НаименованиеПолное КАК СТРОКА(200))
	|		ИНАЧЕ ВЫРАЗИТЬ(ХозрасчетныйОбороты.Регистратор.Контрагент.НаименованиеПолное КАК СТРОКА(200))
	|	КОНЕЦ КАК П000020000106,
	|	ВЫБОР
	|		КОГДА ХозрасчетныйОбороты.Регистратор.Грузоотправитель ЕСТЬ НЕ NULL 
	|				И ХозрасчетныйОбороты.Регистратор.Контрагент.КПП <> ХозрасчетныйОбороты.Регистратор.Грузоотправитель.КПП
	|			ТОГДА ХозрасчетныйОбороты.Регистратор.Грузоотправитель.ИНН
	|		ИНАЧЕ ХозрасчетныйОбороты.Регистратор.Контрагент.ИНН
	|	КОНЕЦ КАК П000020000107,
	|	ВЫБОР
	|		КОГДА ХозрасчетныйОбороты.Регистратор.Грузоотправитель ЕСТЬ НЕ NULL 
	|				И ХозрасчетныйОбороты.Регистратор.Контрагент.КПП <> ХозрасчетныйОбороты.Регистратор.Грузоотправитель.КПП
	|			ТОГДА ХозрасчетныйОбороты.Регистратор.Грузоотправитель.КПП
