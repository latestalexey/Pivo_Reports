...
#Область Запрос_оборотов //14.10.2016 10:46:01
	...
	|	"""" КАК П000010000119,
	|	СУММА(ДанныеОборотов.КоличествоОборотКт * СведенияОбАлкогольнойПродукции.КоэффПересчетаДал) КАК П000010000120,
	...
	|		И НЕ Продажи.Регистратор ССЫЛКА Документ.ВозвратТоваровПоставщику
	|	
	|	ОБЪЕДИНИТЬ ВСЕ
	|	
	|	ВЫБРАТЬ
	...
	|		ПередачаНаОХ.КоличествоОборотКт,
