...
Процедура ПриОткрытии()
	Рез=ВосстановитьЗначение("НастройкиСценариев");
	Если ТипЗнч(Рез)=Тип("ТаблицаЗначений") Тогда
		ДанныеДляСравнения.Загрузить(Рез);
		ЭлементыФормы.КоманднаяПанельФормы.Кнопки.Сценарии.Текст="Сценарии("+ДанныеДляСравнения.Количество()+")";
	КонецЕсли;
...
Процедура ПриЗакрытии()
	...
	СохранитьЗначение("НастройкиСценариев",ДанныеДляСравнения.Выгрузить());
...
//+CRM
Процедура КоманднаяПанельФормыСохранитьРезультаты(Кнопка)
	
	ОбработкаСохранения = Обработки.CRM_СохранениеРезультатаОтчетов.Создать();
	ОбработкаСохранения.УниверсальныйОтчет = УниверсальныйОтчет;
	ОбработкаСохранения.ПолучитьФорму("ФормаСохранения").ОткрытьМодально();
	
КонецПроцедуры


Процедура КоманднаяПанельФормыСценарии(Кнопка)
	ПолучитьФорму("ФормаСценариев").Открыть();
КонецПроцедуры


Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	Если ИмяСобытия="СценарииВыбраны" Тогда
		ЭлементыФормы.КоманднаяПанельФормы.Кнопки.Сценарии.Текст="Сценарии("+ДанныеДляСравнения.Количество()+")";
