...
Процедура ДоработатьКомпоновщикПередВыводом() Экспорт
	...
	ТиповаяАнкета=КомпоновщикНастроек.Настройки.ПараметрыДанных.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("ТиповаяАнкета")).Значение; //наша анкета
	ПараметрМаксБаллы = КомпоновщикНастроек.Настройки.ПараметрыДанных.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("МаксБаллы"));
	ПараметрМаксБаллы.Значение=ТиповаяАнкета.ВопросыАнкеты.Итог("ВесВопроса");
	ПараметрМаксБаллы.Использование=Истина;
	
	МассивГраниц=ОбщегоНазначения.РазложитьСтрокуВМассивПодстрок(ТиповаяАнкета.Вступление,",");
	Граница=КомпоновщикНастроек.Настройки.ПараметрыДанных.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("ГраницаПлохо"));
	Граница.Значение=Число(МассивГраниц[0]);
	Граница.Использование=Истина;
	
	Граница=КомпоновщикНастроек.Настройки.ПараметрыДанных.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("ГраницаУдовлетворительно"));
	Граница.Значение=Число(МассивГраниц[1]);
	Граница.Использование=Истина;
	
	Граница=КомпоновщикНастроек.Настройки.ПараметрыДанных.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("ГраницаХорошо"));
	Граница.Значение=Число(МассивГраниц[2]);
	Граница.Использование=Истина;
