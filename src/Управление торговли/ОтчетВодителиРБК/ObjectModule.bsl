...
Процедура ДоработатьКомпоновщикПередВыводом() Экспорт
	...
	ПараметрДоп = КомпоновщикНастроек.Настройки.ПараметрыДанных.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("РБК"));
	ПараметрДоп.Значение=мРБК;
	ПараметрДоп.Использование=Истина;
	
	ПараметрДоп = КомпоновщикНастроек.Настройки.ПараметрыДанных.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("Перевозчик"));
	ПараметрДоп.Значение=мПеревозчик;
	ПараметрДоп.Использование=Истина;
...
мПеревозчик	=ПланыВидовХарактеристик.СвойстваОбъектов.НайтиПоКоду("000000030");
мРБК		=Справочники.Контрагенты.НайтиПоКоду("000012978");
