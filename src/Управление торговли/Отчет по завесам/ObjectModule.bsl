...
Функция СформироватьОтчет(Результат = Неопределено, ДанныеРасшифровки = Неопределено, ВыводВФормуОтчета = Истина) Экспорт
	ТипЦенНормаСлива=КомпоновщикНастроек.Настройки.ПараметрыДанных.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("ТипЦенНормаСлива"));
	ТипЦенНормаСлива.Использование=Истина;
	ТипЦенНормаСлива.Значение=Справочники.ТипыЦенНоменклатуры.НайтиПоНаименованию("Для расчета нормы слива");
	
	Инвентаризатор=КомпоновщикНастроек.Настройки.ПараметрыДанных.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("Инвентаризатор"));
	Инвентаризатор.Использование=Истина;
	Инвентаризатор.Значение=Константы.о_ПользовательЕжедневныхИнвентаризаций.Получить();
	
	СвойствоНормаПрироста=КомпоновщикНастроек.Настройки.ПараметрыДанных.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("СвойствоНормаПрироста"));
	СвойствоНормаПрироста.Использование=Истина;
	СвойствоНормаПрироста.Значение=ПланыВидовХарактеристик.СвойстваОбъектов.НайтиПоКоду("000000065");
